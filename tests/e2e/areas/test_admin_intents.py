"""Comprehensive functional tests for Intents (/admin/intents).
...
Specifically needs:
  - Intent list shows known intents from intent_registry
    - Add a training example → POST persists → next classification uses it
    - Delete an example → gone from /api/admin/intent-examples
"""
