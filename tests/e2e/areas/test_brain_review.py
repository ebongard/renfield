"""Comprehensive functional tests for Überprüfung (/brain/review).
...
Specifically needs:
  - Queue shows pending atoms → approve one → verify atom promoted (approved flag in DB)
    - Reject → atom stays in queue with reason persisted
    - Auto-archive: verify the gate behaviour per TODOS.md
"""
