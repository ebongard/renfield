"""Comprehensive functional tests for Kameras (/camera).
...
Specifically needs:
  - List of Frigate cameras matches /api/camera response
    - Click a camera → stream/snapshot surface renders
    - Event timeline surfaces recent motion events
"""
