...
- **Turn the ad-hoc eval into a committed gate** — extend `tests/eval/diarization/gates.yaml` with a WER dimension so quality regressions are caught, not discovered.
