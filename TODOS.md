...
### ~~Re-enable `itsm` MCP on build-host when USU customer service is back~~ — entschieden 2026-09-20: kein Renfield-Posten (gehört ins Reva-Backlog; `itsm` kommt in diesem Repo nicht vor)
