...
- **🔐 Full security audit — login & user management** — SCHEDULED to start once **Notes + project-timeline** (business-instance Phase 4) is finished (operator request 2026-07-20). Umbrella over the SSO-cutover + JWT/session-storage debts. Full scope + trigger in **P2 → "🔐 Full security audit — login & user management"**.
