# Postmortem: renfield-pg Totalausfall (2026-09-11/12)

> **Herkunft:** Dieser Befund lag in `tasks/todo.md` — einer Einplatz-Datei, die
> nach der globalen Regel „Plan nach `tasks/todo.md` schreiben" von jedem neuen
> Vorhaben überschrieben wird. Er wäre beim nächsten Plan verloren gewesen.
> Hierher verschoben am 2026-09-19, damit er als Nachschlagewerk Bestand hat.
> Der Ausfall ist behoben (CNPG-Umzug, siehe `k8s/cnpg/`); der Wert des Texts
> liegt in der gemessenen Fehlerkette, nicht im Plan.
