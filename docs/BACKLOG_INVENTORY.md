...
| 82 | Agenten-String-Pfad auf den fusionierten Pfad heben | `get_relevant_context` profitiert nicht von Graph-Expansion — **Achtung: laut `TODOS.md:14` als #874 am 2026-09-02 ausgeliefert; Eintrag wirkt veraltet** | — | `TODOS.md:488` vs. `TODOS.md:14` |
