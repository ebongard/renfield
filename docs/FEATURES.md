...
- **Buchungszeitraum**: Jede Review-Zeile hat editierbare **Monat/Jahr**-Auswahlen (lokalisierte Monatsnamen, Default aktueller Monat/Jahr). Die simba-MCP stempelt einen fehlenden Zeitraum **still** auf HEUTE — deshalb wird er immer angezeigt + gesendet (serverseitig validiert 1–12 / 2000–2100).
