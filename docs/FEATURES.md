...
- **Ein-Klick send→prüfen**: Der „An Simba senden"-Toast enthält einen **„Jetzt prüfen"**-Link direkt zum angelegten Vorschlag (`/brain/review#simba-{id}`, scrollt in Sicht) — kein manuelles Navigieren.
